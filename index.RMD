...
- B is measured in DAG 1(i) from model-based estimates
- Cumulative survival based estimates were associated with non-convergence
...
knitr::include_graphics('images/Varying Non-Adherence - Bias - Faceted2.png')
```
